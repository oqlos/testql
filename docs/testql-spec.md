...
TestQL (Test Query Language) is a declarative DSL for testing GUI, REST API, and hardware encoder interfaces. Files use the `.tql` extension (legacy: `.iql`).
...
```
INCLUDE <file>            # INCLUDE "common-setup.tql"
```
