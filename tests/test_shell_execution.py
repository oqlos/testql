...
class TestShellExecution:
    ...
    def interpreter(self, tmp_path):
        """Create OqlInterpreter with shell capabilities."""
    ...
    def test_shell_echo_command(self, interpreter, tmp_path):
        ...
        line = OqlLine(number=1, command="SHELL", args='"echo hello world" 5000', raw='SHELL "echo hello world" 5000')
    ...
    def test_shell_with_exit_code(self, interpreter):
        ...
        line = OqlLine(number=1, command="SHELL", args='"exit 42" 5000', raw='SHELL "exit 42" 5000')
        interpreter._cmd_shell(line.args, line)
    ...
    def test_assert_exit_code_success(self, interpreter):
        ...
        shell_line = OqlLine(number=1, command="SHELL", args='"echo test"', raw='SHELL "echo test"')
        interpreter._cmd_shell(shell_line.args, shell_line)

        # Then assert exit code
        assert_line = OqlLine(number=2, command="ASSERT_EXIT_CODE", args="0", raw="ASSERT_EXIT_CODE 0")
    ...
    def test_assert_exit_code_failure(self, interpreter):
        ...
        shell_line = OqlLine(number=1, command="SHELL", args='"exit 1"', raw='SHELL "exit 1"')
        interpreter._cmd_shell(shell_line.args, shell_line)
    ...
    def test_assert_stdout_contains_success(self, interpreter):
        ...
        shell_line = OqlLine(number=1, command="SHELL", args='"echo hello world"', raw='SHELL "echo hello world"')
        interpreter._cmd_shell(shell_line.args, shell_line)

        assert_line = OqlLine(number=2, command="ASSERT_STDOUT_CONTAINS", args='"hello"', raw='ASSERT_STDOUT_CONTAINS "hello"')
    ...
    def test_assert_stdout_contains_failure(self, interpreter):
        ...
        assert_line = OqlLine(number=2, command="ASSERT_STDOUT_CONTAINS", args='"goodbye"', raw='ASSERT_STDOUT_CONTAINS "goodbye"')
        interpreter._cmd_assert_stdout_contains(assert_line.args, assert_line)
    ...
    def test_shell_timeout(self, interpreter):
        ...
        line = OqlLine(number=1, command="SHELL", args='"sleep 5" 100', raw='SHELL "sleep 5" 100')
        interpreter._cmd_shell(line.args, line)
    ...
    def test_shell_no_previous_command_warning(self, interpreter):
        ...
        line = OqlLine(number=1, command="ASSERT_EXIT_CODE", args="0", raw="ASSERT_EXIT_CODE 0")
...
class TestShellDryRun:
    ...
    def test_shell_dry_run(self, interpreter):
        ...
        line = OqlLine(number=1, command="SHELL", args='"rm -rf /"', raw='SHELL "rm -rf /"')
        interpreter._cmd_shell(line.args, line)
